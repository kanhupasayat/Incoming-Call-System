"""
Django settings for incomingcall project.
"""
...
ROOT_URLCONF = 'incomingcall.urls'
...
WSGI_APPLICATION = 'incomingcall.wsgi.application'
...
# CORS settings - Allow all origins for webhook
